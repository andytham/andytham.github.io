    ...
    return (
      <div className="project project-featured featured-big" key={project.key}>
        ...
        <a className="anchor-image" target="_blank" href={`${project.url}`}>
          <img className="project-image featured-start" src={require(`./images/${project.shortname}-1-featured.png`)} alt="Featured image" />
          <img className="project-image featured-start featured-end" src={require(`./images/${project.shortname}-2-featured.png`)} alt="Featured image 2" />
        </a>
